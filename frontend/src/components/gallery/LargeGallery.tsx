...
export default function LargeGallery() {
    return (
        <div className="largeGallery">
            ...
            />
            <Link
                href="https://pt.wikipedia.org/wiki/Franco_Columbu"
                target="_blank"
            ...
            />
            <Link
                href="https://pt.wikipedia.org/wiki/Jay_Cutler_(fisiculturista)"
                target="_blank"
                title="Jay Cutler"
            />
            <Link
            ...
            />
            <Link
                href="https://pt.wikipedia.org/wiki/Frank_Zane"
                target="_blank"
                title="Frank Zane"
            />
            <Link
            ...
            />
            <Link
                href="https://pt.wikipedia.org/wiki/Dorian_Yates"
                target="_blank"
                title="Dorian Yates"
            />
        </div>
